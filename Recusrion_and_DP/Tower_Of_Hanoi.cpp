//AIM    - Calculate Minimum number to solve Tower Of Hanoi Problem
//Author - seeitsmanish
#include<bits/stdc++.h>
...
ll Tower_Of_Hanoi(ll S, ll D, ll H, ll n ) {
	if (n == 0) return 1;

	return Tower_Of_Hanoi(S, H, D, n - 1) +
	       Tower_Of_Hanoi(H, D, S, n - 1) + 1;
}
...
int main() {
	...
	while (t--)
	{
		int n; cin >> n;
		ll count = 0;
		cout << Tower_Of_Hanoi(n, 0, 0, n) << endl;
